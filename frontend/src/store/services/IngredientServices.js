...
export const GetIngredients = async (recipe_id) => {
    try{
        const res = await Client.get(`recipe/${recipe_id}/ingredients/`)
...
export const GetIngredientById = async (id) => {
    try{
        const res = await Client.get(`recipe/ingredients/${id}/`)
        return res
    }catch(err){console.log(err)}
}
...
export const AddIngredient = async (recipe_id, ingredient) => {
    ...
    try {
        ...
        const res = await Client.post(`recipe/${recipe_id}/ingredients/`, data)
        return res
    } catch (err) {console.log(err)}
}
...
export const RemoveIngredient = async (id) => {
    try{
        const res = await Client.delete(`recipe/ingredients/${id}/`)
        return res
    } catch (err) {console.log(err)}
}
export const UpdateIngredient = async (id, details) => {
    try {
        const res = await Client.put(`recipe/ingredients/${id}/`, details)
